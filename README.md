...
List of software/websites/databases/papers for genome engineering, including (but not limited to) guide design, genome editing outcome, screening analysis, etc. [Contributions welcome](https://github.com/davidliwei/awesome-CRISPR/blob/master/CONTRIBUTING.md) ⭐ 582 | 🐛 1 | 📅 2026-07-29..

This collection is inspired by [awesome-single-cell](https://github.com/seandavi/awesome-single-cell) ⭐ 3,858 | 🐛 12 | 📅 2026-09-07.
...
* [pydna](https://github.com/pydna-group/pydna) ⭐ 229 | 🐛 65 | 🌐 Python | 📅 2026-09-21 - \[python] - A Python library to simulate and document reproducible cloning strategies, including CRISPR-Cas9 cut simulation and CRISPR-mediated engineering. [BMC Bioinfo](https://doi.org/10.1186/s12859-015-0544-x)
* [OpenCloning](https://opencloning.org) - \[webserver] - An open-source web application to plan and document cloning and genome engineering, including CRISPR-based strain engineering. [code](https://github.com/manulera/OpenCloning) ⭐ 55 | 🐛 23 | 🌐 Dockerfile | 📅 2026-09-21
...
* [CRISPRme](http://crisprme.di.univr.it/) - \[webserver] - CRISPRme is a tool for comprehensive off-target assessment that considers effects of human genetic variants. [code](https://github.com/pinellolab/crisprme) ⭐ 28 | 🐛 5 | 🌐 Python | 📅 2026-09-17 **Recommended**
...
* [CRIS.py](https://github.com/patrickc01/CRIS.py) ⭐ 28 | 🐛 2 | 🌐 Python | 📅 2023-08-08 - \[Python] - A versatile and high-throughput analysis program for CRISPR-based genome editing.
* [CrispRVariants](https://github.com/markrobinsonuzh/CrispRVariants) ⭐ 26 | 🐛 12 | 🌐 R | 📅 2020-10-15 - \[R] - A R-based toolkit for counting, localizing and plotting targeted insertion and deletion variant combinations from CRISPR-Cas9 mutagenesis experiments.
* [CRISPR-DAV](https://github.com/pinetree1/crispr-dav.git) ⭐ 17 | 🐛 1 | 🌐 Perl | 📅 2019-07-26 - \[Perl, R] - A CRISPR NGS data analysis and visualization pipeline.
* [crispr-DART](https://github.com/BIMSBbioinfo/crispr_DART) ⭐ 12 | 🐛 2 | 🌐 R | 📅 2024-02-01 - \[Python, R] - A workflow to analyze CRISPR-Cas-induced indel mutations in targeted/amplicon DNA sequencing. Can work with single/multiplexed sgRNAs per region(s).
* [CRISPRmatch](https://github.com/zhangtaolab/CRISPRMatch) ⚠️ Archived - \[Python] - An automatic calculation and visualization tool for high-throughput CRISPR genome-editing data analysis.
* [AmpliconDIVider](https://github.com/mlafave/ampliconDIVider) ⭐ 3 | 🐛 0 | 🌐 Shell | 📅 2016-01-28 - \[Perl] - AmpliconDIVider contains the scripts used to identify deletion and insertion variants (DIVs) in DNA amplicons.
* [BATCH-GE](https://github.com/WouterSteyaert/BATCH-GE.git) ⭐ 1 | 🐛 1 | 🌐 Java | 📅 2018-02-07 - \[Perl] - A batch analysis of Next-Generation Sequencing data for genome editing assessment.
...
* [ScreenProcessing](https://github.com/mhorlbeck/ScreenProcessing) ⭐ 73 | 🐛 10 | 🌐 Python | 📅 2023-08-19 - \[Python] - A complete pipeline for processing data generated by the genome-scale CRISPR screen platform developed at the [Weissman Lab](https://weissman.wi.mit.edu/resources/). It offers key features and careful implementation in comparison to MAGeCK. Paper: [eLife 2016](https://doi.org/10.7554/eLife.19760)
* [ScreenPro2](https://github.com/ArcInstitute/ScreenPro2) ⭐ 34 | 🐛 12 | 🌐 Python | 📅 2026-09-14 – \[Python] – Flexible analysis of high-content CRISPR screening. **Recommended**
...
* [MAUDE](https://github.com/Carldeboer/MAUDE) ⭐ 1 | 🐛 0 | 🌐 HTML | 📅 2022-02-26 - \[R] - An R package for analyzing sorting-based (e.g FACS) CRISPR screens and other high-throughput screens with a sorting readout.
