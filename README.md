...
* [pydna](https://github.com/pydna-group/pydna) ⭐ 229 | 🐛 65 | 🌐 Python | 📅 2026-09-14 - \[python] - A Python library to simulate and document reproducible cloning strategies, including CRISPR-Cas9 cut simulation and CRISPR-mediated engineering. [BMC Bioinfo](https://doi.org/10.1186/s12859-015-0544-x)
...
* [CRISPRme](http://crisprme.di.univr.it/) - \[webserver] - CRISPRme is a tool for comprehensive off-target assessment that considers effects of human genetic variants. [code](https://github.com/pinellolab/crisprme) ⭐ 28 | 🐛 5 | 🌐 Python | 📅 2026-09-13 **Recommended**
...
* [ScreenPro2](https://github.com/ArcInstitute/ScreenPro2) ⭐ 34 | 🐛 12 | 🌐 Python | 📅 2026-09-13 – \[Python] – Flexible analysis of high-content CRISPR screening. **Recommended**
