...
This collection is inspired by [awesome-single-cell](https://github.com/seandavi/awesome-single-cell) ⭐ 3,856 | 🐛 12 | 📅 2026-09-07.
...
* [CRISPRme](http://crisprme.di.univr.it/) - \[webserver] - CRISPRme is a tool for comprehensive off-target assessment that considers effects of human genetic variants. [code](https://github.com/pinellolab/crisprme) ⭐ 28 | 🐛 5 | 🌐 Python | 📅 2026-09-12 **Recommended**
...
* [ScreenPro2](https://github.com/ArcInstitute/ScreenPro2) ⭐ 33 | 🐛 12 | 🌐 Python | 📅 2026-09-12 – \[Python] – Flexible analysis of high-content CRISPR screening. **Recommended**
