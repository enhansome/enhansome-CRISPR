...
This collection is inspired by [awesome-single-cell](https://github.com/seandavi/awesome-single-cell) ⭐ 3,855 | 🐛 12 | 📅 2026-09-07.
...
* [pydna](https://github.com/pydna-group/pydna) ⭐ 229 | 🐛 63 | 🌐 Python | 📅 2026-09-10 - \[python] - A Python library to simulate and document reproducible cloning strategies, including CRISPR-Cas9 cut simulation and CRISPR-mediated engineering. [BMC Bioinfo](https://doi.org/10.1186/s12859-015-0544-x)
* [OpenCloning](https://opencloning.org) - \[webserver] - An open-source web application to plan and document cloning and genome engineering, including CRISPR-based strain engineering. [code](https://github.com/manulera/OpenCloning) ⭐ 55 | 🐛 23 | 🌐 Dockerfile | 📅 2026-08-11
...
* [CRISPRme](http://crisprme.di.univr.it/) - \[webserver] - CRISPRme is a tool for comprehensive off-target assessment that considers effects of human genetic variants. [code](https://github.com/pinellolab/crisprme) ⭐ 28 | 🐛 5 | 🌐 Python | 📅 2026-08-24 **Recommended**
...
* [ScreenPro2](https://github.com/ArcInstitute/ScreenPro2) ⭐ 33 | 🐛 12 | 🌐 Python | 📅 2026-03-06 – \[Python] – Flexible analysis of high-content CRISPR screening. **Recommended**
...
* [MinCED](https://github.com/ctSkennerton/minced) ⭐ 125 | 🐛 7 | 🌐 Java | 📅 2023-02-10 - \[Java] - A program to find Clustered Regularly Interspaced Short Palindromic Repeats (CRISPRs) in full genomes or environmental datasets such as assembled contigs from metagenomes.
