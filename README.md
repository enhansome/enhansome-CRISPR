...
This collection is inspired by [awesome-single-cell](https://github.com/seandavi/awesome-single-cell) ⭐ 3,862 | 🐛 12 | 📅 2026-09-07.
...
* [OpenCloning](https://opencloning.org) - \[webserver] - An open-source web application to plan and document cloning and genome engineering, including CRISPR-based strain engineering. [code](https://github.com/manulera/OpenCloning) ⭐ 57 | 🐛 23 | 🌐 Dockerfile | 📅 2026-09-21
